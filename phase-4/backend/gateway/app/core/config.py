"""Phase 4 gateway config — extends Phase 2 config with Phase 4 service URLs."""
...
class Settings(BaseSettings):
    ...
    AI_COPILOT_SERVICE_URL: str = "http://localhost:8009"
    DOCS_SERVICE_URL: str = "http://localhost:8010"
